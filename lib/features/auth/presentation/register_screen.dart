...
class _RegisterScreenState extends ConsumerState<RegisterScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (mounted) context.goNamed(AppRoute.messSelection.name);
    } catch (e) {
              ...
              child: ConstrainedBox(
                ...
                child: LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    final registerCard = ConstrainedBox(
                        ...
                        child: Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Set up your space and invite teammates to manage meals and money together.',
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 14),
        Text(
          'Start a mess that feels organized from day one.',
        ...
        Text(
          'Invite members, track meals, and keep balances transparent.',
        ...
        Wrap(
          ...
          runSpacing: 10,
          children: const [
            _FeatureChip(icon: Icons.groups_2_outlined, label: 'Invite instantly'),
            _FeatureChip(icon: Icons.receipt_long_outlined, label: 'Shared expenses'),
            _FeatureChip(icon: Icons.check_circle_outline, label: 'Clear balances'),
          ],
        ),
        const SizedBox(height: 18),
        Row(
